    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent className="text-gray-400 bg-black">
                ...
                <DropdownMenuItem onClick={handleSignOut} className="text-gray-100 bg-black text-md font-medium focus:bg-transparent focus:text-yellow-500 transition-colors cursor-pointer">
